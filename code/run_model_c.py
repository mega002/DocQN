...
from models.estimator_c import *
...
def load_data(use_rpc):
    ...
    if use_rpc:
        ...
        evidence_dict = EvidenceRpcClient(coupled=True)
    else:
        # load evidence dict
        print("Loading evidence dict...", end='')
        with open(DATA_CONFIG_.evidence_dict_path, 'rb') as fd:
...
def main():
    ...
    word_embeddings, encoder, evidence_dict, train_samples, dev_samples = load_data(args.use_rpc)
