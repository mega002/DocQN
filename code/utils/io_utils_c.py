...
from utils.tree_navigation_c import ACTIONS, get_node_dist, get_evidence_title
...
def parse_args():
    ...
    parser.add_argument('--use_rpc', action='store_true', default=False, help='Use evidence RPC server')
...
def write_step_end_msg(flog, node, next_node):
    if flog is None:
        return
